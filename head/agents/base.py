"""Model-independent HEAD agent input/output contract."""
...
class AgentInput:
    ...
    New history-only agents must not use recorded future states. The legacy
    Pluto adapter declares input_scope="legacy_logged_route" because its route
    builder uses the full recorded ego path; see its README. Positions:
