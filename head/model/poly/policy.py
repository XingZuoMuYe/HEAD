...
from head.model.poly.common.utils import smooth_curve
from head.model.poly.common.config import cfg, cfg_from_yaml_file
from head.model.poly.common.local_planner.frenet_optimal_trajectory import FrenetPlanner as MotionPlanner
from head.model.poly.common.utils import EGO_POSE, calc_cur_s, calc_cur_d, preview_point, match_point, \
    calculate_laterror
import math
import os
...
class RLPlanningPolicy(EnvInputPolicy):
    def __init__(self, obj, seed):
        ...
        self.cfg = cfg_from_yaml_file(root_path + '/common/cfgs/config.yaml', cfg)
