...
class DecoderLayer(nn.Module):
    ...
    def forward(
        ...
        tgt2 = self.r2r_attn(
            ...
            # tgt2, tgt2, tgt2, key_padding_mask=tgt_key_padding_mask.unsqueeze(2).repeat(1, 1, M).transpose(1, 2).reshape(bs * M, R)
        )[0]
...
class PlanningDecoder(nn.Module):
    def __init__(
        ...
        self.feature_probe = nn.Identity()  # parameter-free shared pre-head SAE hook
