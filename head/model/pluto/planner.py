...
from head.model.pluto.features.builder import PlutoTestDataset
from head.model.pluto.model.pluto_model import PlanningModel
...
class PlutoInference:
    ...
    def run_inference(self, current_state, timestep, controlled_agent_id=None):
        ...
        with torch.no_grad():
            ...
            from head.model.pluto.features.pluto_utils import collate_pluto_dicts, to_feature_tensor_dict
