...
from head.model.pluto.features.cost_map_manager import CostMapManager
from head.model.pluto.features.utils import save_dict_to_hdf5
from head.model.common.base_dataset import BaseDataset
from scenarionet.common_utils import read_scenario

from shapely.geometry import Polygon
from shapely.geometry import Point, LineString
from typing import List, Tuple
from head.model.pluto.features.pluto_utils import calculate_additional_ego_states, \
    PlutoFeature, interpolate_polyline, _is_lane_like

from head.model.pluto.features.map_topology import build_lane_graph, estimate_route_lane_ids, _as_int_id
...
class PlutoDataset(BaseDataset):
    ...
    def process(self, data, current_step=20, controlled_agent_id=None):
        ...
        if controlled_cache_key not in self._route_lane_cache:
            ...
            #         from head.model.pluto.features.plot_lane_graph import dump_lane_graph_to_json, plot_lane_graph
